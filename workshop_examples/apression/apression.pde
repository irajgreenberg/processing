...
// z = -100
float xShift = 0, yShift = 0, zShift = 150; 
...
void setup() {
  ...
  xShift = width/2;
  yShift = height/2;
  surf = new VerletSurfaceRect(new PVector(), new Dimension3D(1000, 0, 1000), surfRows, surfCols, edgeFlags, .999/*.45*/);
